  ...
  function makeOS(root) {
    return {
      ...
      draw: function (dt) {
        ...
        c.globalCompositeOperation = 'destination-out'; c.fillStyle = 'rgba(0,0,0,0.22)'; c.fillRect(0, 0, W, H); c.globalCompositeOperation = 'source-over';
        this.brands.forEach(function (b) {
          if (!b.active) return;
        ...
        var ce = document.querySelector('[data-oscount]');
        if (ce) ce.textContent = (3847 + this.counter).toLocaleString();
      },
      stop: function () {
